                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-6">
                                    @if ($ticket_detail->creative != '')
                                        <a href="{{ '/' . $ticket_detail->creative }}" target="_blank"
                                            download="{!! $ticket_detail->creative !!}">Download Creative</a>
                                </div>
                                <div class="col-md-6">
                                    <div class="modal-footer">
                                        <span class="pull-left">
                                            <form method="POST" role="form"
                                                action="{{ route('approve', $ticket_detail->no) }}">
                                        ...
                                        <span class="pull-right">
                                            ...
                                            <form method="POST" role="form"
                                                action="{{ route('reject', $ticket_detail->no) }}">
                                                @csrf
                                                <input type="hidden" name="id" value="{{ $ticket_detail->no }}">
